...
#ifndef IMNUCOIN_QT_IMNUCOINUNITS_H
#define IMNUCOIN_QT_IMNUCOINUNITS_H
...
/** Imnucoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ImnucoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ImnucoinUnits(QObject *parent);

    /** Imnucoin units.
      @note Source: https://en.imnucoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        IMNUC,
...
typedef ImnucoinUnits::Unit ImnucoinUnit;

#endif // IMNUCOIN_QT_IMNUCOINUNITS_H
