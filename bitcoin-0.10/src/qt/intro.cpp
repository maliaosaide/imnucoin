...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/imnucoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Imnucoin Core"),
     ...
     * override -datadir in the imnucoin.conf file in the default data directory
     * (to be consistent with imnucoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
