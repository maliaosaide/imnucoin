...
#if defined(NDEBUG)
# error "Imnucoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Imnucoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("imnucoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    else if (fAlerts && strCommand == "alert")
    {
        ...
        // See https://imnucoin.org/en/alert/2016-11-01-alert-retirement
    }
