...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Imnucoin Core imnucoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  imnucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded imnucoin transaction") + "\n" +
              "  imnucoin-tx [options] -create [commands]   " + _("Create hex-encoded imnucoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded imnucoin transaction
