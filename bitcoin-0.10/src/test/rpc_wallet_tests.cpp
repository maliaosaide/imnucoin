...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CImnucoinAddress demoAddress = CImnucoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CImnucoinAddress setaccountDemoAddress = CImnucoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CImnucoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CImnucoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
