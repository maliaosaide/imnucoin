...
#ifndef IMNUCOIN_RPCPROTOCOL_H
#define IMNUCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Imnucoin is not connected
