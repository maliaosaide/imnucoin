...
from test_framework import ImnucoinTestFramework
...
class TxnMallTest(ImnucoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 IMNUC:
        ...
        # First: use raw transaction API to send 1210 IMNUC to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50IMNUC for another
        ...
        # Node0's total balance should be starting balance, plus 100IMNUC for 
