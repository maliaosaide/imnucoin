The following is a list of assets used in the imnucoin source and their proper attribution.
...
* License: MIT
* Site: [https://imnucointalk.org/index.php?topic=15276.0](https://imnucointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original imnucoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/imnucoin.icns, src/qt/res/src/imnucoin.svg,
	src/qt/res/src/imnucoin.ico, src/qt/res/src/imnucoin.png,
	src/qt/res/src/imnucoin_testnet.png, docs/imnucoin_logo_doxygen.png,
