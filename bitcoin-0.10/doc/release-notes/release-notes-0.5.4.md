Imnucoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/imnucoin/files/Imnucoin/imnucoin-0.5.4/
...
http://gitorious.org/imnucoin/imnucoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Imnucoin-Qt notifications under Growl 1.3.
Increase required age of Imnucoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxImnucoin properly when installing Imnucoin-Qt over it. (Windows)
