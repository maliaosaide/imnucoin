Imnucoin Core version 0.9.2.1 is now available from:

  https://imnucoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 IMNUC to 0.01 IMNUC
...
- Fix "Start imnucoin on system login"
