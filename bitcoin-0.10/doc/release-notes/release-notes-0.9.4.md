Imnucoin Core version 0.9.4 is now available from:

  https://imnucoin.org/bin/0.9.4/
...
this update is incompatible with the Imnucoin system and could lead to consensus
forks.

Imnucoin Core released binaries from https://imnucoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~imnucoin/+archive/ubuntu/imnucoin
- A third-party or self-compiled Imnucoin Core

upgrade to Imnucoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
