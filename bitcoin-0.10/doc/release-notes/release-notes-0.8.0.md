Imnucoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/imnucoin/files/Imnucoin/imnucoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Imnucoin
...
New/changed settings (command-line or imnucoin.conf file)
--------------------------------------------------------
