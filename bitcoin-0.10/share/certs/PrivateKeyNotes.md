...
unlocked to sign the Imnucoin-Qt.app bundle.
...
allowing somebody to distribute a Imnucoin-Qt.app or imnucoin-qt-setup.exe with a valid
...
that the imnucoin-qt.exe file inside the installer had not been tampered with.
