...
###   This script attempts to download the signature file SHA256SUMS.asc from imnucoin.org
...
WORKINGDIR="/tmp/imnucoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://imnucoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://imnucoin.org/bin/"
VERSIONPREFIX="imnucoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'imnucoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[imnucoin-]<version>-[rc[0-9]] (example: imnucoin-0.9.2-rc1)"
   echo "wget output:"
